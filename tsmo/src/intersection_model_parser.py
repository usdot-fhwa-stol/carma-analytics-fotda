...
def intersectionModelParser():
    ...
    for file in all_in_filenames:
        if "intersection_model.json" in file:
            ...
            with open(f'{input_directory_path}/intersection_model_parsed.csv', 'w', newline='') as write_obj:
...
if __name__ == '__main__':
    if len(sys.argv) < 1:
        print('Run with: "python intersection_model_parser.py"')
    else:       
        intersectionModelParser()