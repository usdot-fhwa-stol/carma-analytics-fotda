...
""" This script needs to be run with an argument for the scheduling_service csv log file. ./parse_schedule_csv_logs.py <log_file.csv>
A single plot consists of entering times for a run, which is marked by linebreaks in the csv. 
The resulting plot is between timestamp entry and entering time entry.
The plot also shows the state ("EV" or "DV") which corresponds with the given data entry. """
