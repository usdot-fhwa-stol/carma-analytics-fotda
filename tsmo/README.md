...
the required plots to validate Carma-Streets UC3 functionality. Th Inside of the "tsmo" directory, create a "data" directory with a set of subdirectories that are called out in the "constants.py"
