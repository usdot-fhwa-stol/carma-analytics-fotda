...
Using the scripts in this package we should be able to ingest all Kafka Topic Logs and produces CSV data from the resulting messages for data analysis.