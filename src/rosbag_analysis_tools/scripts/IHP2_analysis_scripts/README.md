The data analysis script in this repository is based on testing completed for the Integrated Highway Prototype II (IHP2) system, and that is documented in the Integrated Highway Prototype II System Validation Report.
